        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-3">
             ...
             <div className="flex items-center gap-3">
               <SocialIcon href="https://web.facebook.com/muhammad.saqib.718278" icon={SiFacebook ? <SiFacebook className="w-4 h-4" /> : null} />
               <SocialIcon href="https://www.instagram.com/mr_saqib242" icon={SiInstagram ? <SiInstagram className="w-4 h-4" /> : null} />
               <SocialIcon href="https://www.tiktok.com/@mr_saqib_242" icon={SiTiktok ? <SiTiktok className="w-4 h-4" /> : null} />
               <SocialIcon href="https://www.snapchat.com/add/mrsaqib242" icon={SiSnapchat ? <SiSnapchat className="w-4 h-4" /> : null} />
             </div>
          </div>
          ...
          <div className="lg:col-span-5">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <ContactCard 
                   ...
                   icon={SiWhatsapp ? <SiWhatsapp className="w-4 h-4 text-emerald-400" /> : null}
                />
                <ContactCard 
