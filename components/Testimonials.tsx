             ...
             <div className="flex -space-x-3">
               {[1, 2, 3, 4].map(i => (
                 <div key={i} className="w-10 h-10 rounded-full border-2 border-[#050508] overflow-hidden grayscale hover:grayscale-0 transition-all cursor-pointer">
                   <Image src={`https://picsum.photos/seed/face${i}/50/50`} width={40} height={40} alt="User" referrerPolicy="no-referrer" />
                 </div>
               ))}
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-14 h-14 rounded-2xl overflow-hidden border border-white/10 p-0.5 bg-gradient-to-br from-emerald-500/20 to-transparent">
                    <Image 
                      ...
                      width={56} 
                      height={56} 
                      className="rounded-[14px] object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
