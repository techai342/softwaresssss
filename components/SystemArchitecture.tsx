...
const ArchitectureDiagram = ({
  ...
  activeLayer: ArchLayer;
  onLayerSelect: (layer: ArchLayer) => void;
}) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-[650px] flex items-center justify-center bg-[#050508] p-4 overflow-hidden rounded-[32px] border border-white/5"
    >
      <div
      ...
      >
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-visible">
          ...
          {isActive(ArchLayer.CLIENT) && (
            <path
              d="M 220 320 L 220 220"
              stroke="#ec4899"
              strokeWidth="2"
              strokeDasharray="5,5"
          ...
          <path
            d="M 370 130 C 450 130, 450 260, 500 260"
            stroke="#1e293b"
            strokeWidth="2"
            fill="none"
          ...
          {isActive(ArchLayer.FRONTEND) && (
            <>
              <path
                ...
                fill="none"
              />
              <text x="400" y="180" fill="#3b82f6" fontSize="10" fontFamily="monospace" className="font-bold">
                HTTP/JSON
              </text>
            </>
          )}
          ...
          {isActive(ArchLayer.API_GATEWAY) && (
            <path
              d="M 660 260 L 700 260"
              stroke="#a855f7"
              strokeWidth="2"
              strokeDasharray="5,5"
              className="animate-dash"
          ...
          {isActive(ArchLayer.BACKEND) && (
            <>
              <path
                ...
                fill="none"
              />
              <text x="885" y="450" fill="#eab308" fontSize="10" fontFamily="monospace" className="font-bold">
                TCP/SQL
              </text>
            </>
          )}
        ...
        >
          <div className="absolute inset-0 rounded-full border border-white/5 scale-110 opacity-30 animate-pulse pointer-events-none" />
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 h-full border-t-[8px] border-black/30 rounded-t-[50px] pointer-events-none" />
        </div>
      </div>
    </div>
  );
        ...
        <div className="xl:col-span-1 space-y-6 order-2 xl:order-1">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-10 font-medium">{layerDetails[activeLayer].desc}</p>
