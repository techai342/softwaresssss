      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative p-8 md:p-12 rounded-[50px] bg-[#0A0A0E] border border-white/5 overflow-hidden">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20 hidden md:block" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path d="M 50 50 L 20 20" className="stroke-white stroke-[0.1]" strokeDasharray="1 1" />
            <path d="M 50 50 L 80 20" className="stroke-white stroke-[0.1]" strokeDasharray="1 1" />
            <path d="M 50 50 L 20 80" className="stroke-white stroke-[0.1]" strokeDasharray="1 1" />
            <path d="M 50 50 L 80 80" className="stroke-white stroke-[0.1]" strokeDasharray="1 1" />
          </svg>
        </div>
