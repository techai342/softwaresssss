          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full bg-[#0d0f14] rounded-[23px] p-10 items-center text-center">
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl bg-[#171a23] border border-white/5 group-hover:bg-white/5 transition-colors text-[11px] font-black tracking-widest uppercase text-white shadow-lg overflow-hidden relative"
              >
